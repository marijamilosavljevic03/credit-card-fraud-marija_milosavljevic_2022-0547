...
Balansiranje klasa — SMOTE (omjer 1:3):
...
Neravnoteža klasa — rešena kombinacijom SMOTE tehnike (sa blažim, 1:3 omjerom balansiranja umesto potpunog izjednačavanja) i pažljivim izborom evaluacionih metrika.
...
Izbor arhitekture mreže — analiza osetljivosti je pokazala da veličina/dubina mreže ima znatno veći uticaj na rezultat od izbora aktivacione funkcije, što je bio koristan uvid za dalje eksperimentisanje.
